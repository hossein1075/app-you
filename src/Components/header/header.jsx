...
export default function Header() {
  ...
  {/* محتوای اصلی */}
        <div className='container'>
          <div className='flex gap-5 max-lg:mt-10 mt-32 text-white'>
            <div className='w-101 h-142 basis-[50%] max-lg:hidden z-10'>
              <img src="./public/images/header-mobile.png" className='w-full' alt="app weather" />
            </div>

            <div className='relative max-md:mt-5 mt-20'>
              <h1 className='max-w-184 font-Av text-6xl max-md:text-4-5xl font-medium leading-5.6 max-lg:5 mb-2.5'>کارهای شگفت انگیز خود را از طریق اپ یو شروع کنید.</h1>
              <p className='max-w-163 max-md:my-6 mt-5 mb-2.5'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز</p>
